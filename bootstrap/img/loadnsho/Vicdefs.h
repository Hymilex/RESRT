...
int _export WINAPI addtextw(unsigned int color, int pointsize, LPCSTR font, LPCWSTR atext, imgdes far *desimg);
int _export WINAPI addtextexw(unsigned int color, LOGFONT *lfont, LPCWSTR atext, imgdes far *desimg);
...
void _export WINAPI freeexifdatabuffer(UCHAR *buffAddr);
...
int _export WINAPI loadjpegexifdatatobuffer(LPCSTR afname, UCHAR * *buffAddr, int *bufflength);
...
int _export WINAPI savejpegwithexifdata(LPCSTR afname, imgdes far *srcimg, int qual, int saveMode, UCHAR *exifaddr, int exiflength);
...
int _export WINAPI correlationcoefRGB(imgdes *srcimg, imgdes *oprimg, double *predCoef, double *pgrnCoef, double *pbluCoef);
